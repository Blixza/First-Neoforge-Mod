...
public class GrowthChamberRecipeCategory implements IRecipeCategory<GrowthChamberRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(MyMod.MOD_ID, "growth_chamber");
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MyMod.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.mymod.growth_chamber");
    }
