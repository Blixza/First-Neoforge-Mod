...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.BISMUTH.get(), 18)
                ...
                .save(recipeOutput, "forgemod:bismuth_from_magic_block");
        ...
        trimSmithing(recipeOutput, ModItems.NANACHI_SMITHING_TEMPLATE.get(), ResourceLocation.fromNamespaceAndPath(MyMod.MOD_ID, "nanachi"));
    }
