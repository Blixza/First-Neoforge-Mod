...
public class ModItems {
    ...
    public static final DeferredItem<HammerItem> BISMUTH_HAMMER = ITEMS.register("bismuth_hammer",
            () -> new HammerItem(ModToolTiers.BISMUTH, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BISMUTH, 7F, -3.5f))));
    ...
    public static final DeferredItem<Item> NANACHI_SMITHING_TEMPLATE = ITEMS.register("nanachi_armor_trim_smithing_template",
            () -> SmithingTemplateItem.createArmorTrimTemplate(ResourceLocation.fromNamespaceAndPath(MyMod.MOD_ID, "nanachi")));

    public static final DeferredItem<Item> NANACHI_BOW = ITEMS.register("nanachi_bow",
            () -> new BowItem(new Item.Properties().durability(500)));

    public static final DeferredItem<Item> I_DONT_CARE_MUSIC_DISC = ITEMS.register("i_dont_care_music_disc",
            () -> new Item(new Item.Properties().jukeboxPlayable(ModSounds.I_DONT_CARE_KEY).stacksTo(1)));
    public static final DeferredItem<Item> CHERY_TIGGO_MUSIC_DISC = ITEMS.register("chery_tiggo_music_disc",
            () -> new Item(new Item.Properties().jukeboxPlayable(ModSounds.CHERY_TIGGO_KEY).stacksTo(1)));
