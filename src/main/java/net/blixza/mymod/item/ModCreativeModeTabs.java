...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_ITEMS_TAB = CREATIVE_MODE_TAB.register("bismuth_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BISMUTH.get()))
                    .title(Component.translatable("creativetab.mymod.bismuth_items"))
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModItems.NANACHI_BOW);
                        output.accept(ModItems.I_DONT_CARE_MUSIC_DISC);
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_BLOCKS_TAB = CREATIVE_MODE_TAB.register("bismuth_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.BISMUTH_BLOCK.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MyMod.MOD_ID, "bismuth_items_tab"))
                    .title(Component.translatable("creativetab.mymod.bismuth_items"))
                    .displayItems((itemDisplayParameters, output) -> {
